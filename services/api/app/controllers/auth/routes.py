...
async def login(payload: LoginRequest, db=Depends(get_prisma)) -> AuthResponse:
...
async def register(payload: RegisterRequest, db=Depends(get_prisma)) -> AuthResponse:
...
async def logout(session=Depends(get_session), db=Depends(get_prisma)) -> MessageResponse:
